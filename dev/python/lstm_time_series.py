...
########## Fonction pour formatter les données en inputs et outputs ##########
...
if __name__ == '__main__':
    datafile_train = "ML_tests/normal10000.json"
    datafile_test = "ML_tests/train_normal800.json"
    datafile_anomalous = "ML_tests/2abnormal1000.json"
